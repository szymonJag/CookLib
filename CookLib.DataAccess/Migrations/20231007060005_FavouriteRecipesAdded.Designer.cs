...
namespace CookLib.DataAccess.Migrations
{
    ...
    [Migration("20231007060005_FavouriteRecipesAdded")]
    partial class FavouriteRecipesAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CookLib.DataAccess.Entities.Image", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CookLib.DataAccess.Entities.Image", b =>
                {
                    b.HasOne("CookLib.DataAccess.Entities.Recipe", null)
                        .WithMany("Images")
                        .HasForeignKey("RecipeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
